use super::{
    ...
    HISTORY_VIEW_QUERY, INFERRED_NAME_PATH, NAME_PATH, NAMESPACE_PATH, NAMESPACE_QUERY,
    PAGE_SIZE_QUERY, RECORDS_QUERY, REQUIRED_NAMESPACE_QUERY, RESOLUTION_MODE_QUERY,
    RESOLVER_ADDRESS_PATH, RESOURCE_ID_PATH, SUMMARY_META_QUERY,
};
...
pub(crate) const RESOLVE_CURRENT_PARAMETERS: &[ApiRouteParameter] =
    &[INFERRED_NAME_PATH, RESOLUTION_MODE_QUERY, RECORDS_QUERY];
