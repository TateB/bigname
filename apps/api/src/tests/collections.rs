                ...
                "permissions": {
                    ...
                    "items": [{
                        ...
                        "grant_source": {
                            ...
                            "resolver_contract_instance_id": "00000000-0000-0000-0000-00000000c210",
                        },
        ...
        &[
            bigname_storage::NormalizedEvent {
                ...
                after_state: json!({
                    ...
                    "grant_source": {
                        ...
                        "authority_kind": "registrant",
                        "authority_key": format!("basenames:{resource_id}:registrant"),
            ...
            bigname_storage::NormalizedEvent {
                ...
                after_state: json!({
                    ...
                    "grant_source": {
                        "kind": "ens_v1_authority",
                        "authority_kind": "resolver",
                        "authority_key": format!("basenames:{resource_id}:resolver"),
