...
-- avoids record-inventory or provenance hydration. Keep the displayed fields in
-- a covering index so high-cardinality feed batches do not touch the row heap.
