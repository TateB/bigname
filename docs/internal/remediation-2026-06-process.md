...
| WS-B ENSv2 + preimage | merged | `fix/ws-b-ensv2-preimage` | [#22](https://github.com/TateB/bigname/pull/22) | Merged f29f48e; projection-consumption P1 split out (Projections owner); robustness P3 pending |
