...
- `docs/operations.md` § Decisions captured here
- `docs/storage.md` § Identity strategy
...
| --- | --- | --- | --- |
| Platform and DevEx | workspace bootstrap, CI, local dev, config loading | `operations.md` | Rust workspace, compose/dev env, CI gates |
